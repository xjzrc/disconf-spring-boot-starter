...
public class DisconfProperties {
     ...
     * disconf包扫描路径
     */
    @DisconfConfigAnnotation(springBootName = "scan-package", disconName = "disconf.scanPackage")
    private String scanPackage;

    /**
     * 在disconf-web上修改配置文件时，不会reload到系统里的服务器配置文件（给spring托管）
     */
    @DisconfConfigAnnotation(springBootName = "un-reload-files", disconName = "disconf.unReloadFiles")
    private String unReloadFiles;

    /**
     * 在disconf-web上修改配置文件时，会reload到系统里的服务器配置文件（给spring托管）
     */
    @DisconfConfigAnnotation(springBootName = "reload-files", disconName = "disconf.reloadFiles")
     ...
     */
    @DisconfConfigAnnotation(springBootName = "enable-remote-conf", disconName = "disconf.enable.remote.conf", defaultValue = "false")
     ...
     */
    @DisconfConfigAnnotation(springBootName = "conf-server-host", disconName = "disconf.conf_server_host")
    private String confServerHost;

    /**
     * 版本, 请采用 X_X_X_X 格式
     */
    @DisconfConfigAnnotation(springBootName = "version", disconName = "disconf.version")
    private String version;

    /**
     * 主或备
     */
    @DisconfConfigAnnotation(springBootName = "main_type", disconName = "disconf.maintype")
    private String mainType;

    /**
     * APP 请采用 产品线_服务名 格式
     */
    @DisconfConfigAnnotation(springBootName = "app", disconName = "disconf.app")
    private String app;

    /**
     * 环境
     */
    @DisconfConfigAnnotation(springBootName = "env", disconName = "disconf.env")
    private String env;
     ...
     */
    @DisconfConfigAnnotation(springBootName = "debug", disconName = "disconf.debug", defaultValue = "false")
    private boolean debug = false;

    /**
     * 忽略哪些分布式配置，用逗号分隔
     */
    @DisconfConfigAnnotation(springBootName = "ignore", disconName = "disconf.ignore")
    private String ignore;

    /**
     * 获取远程配置 重试次数，默认是3次
     */
    @DisconfConfigAnnotation(springBootName = "conf-server-url-retry-times", disconName = "disconf.conf_server_url_retry_times", defaultValue = "3")
    private int confServerUrlRetryTimes = 3;

    /**
     * 获取远程配置 重试时休眠时间，默认是5秒
     */
    @DisconfConfigAnnotation(springBootName = "conf-server-url-retry-sleep-seconds", disconName = "disconf.conf_server_url_retry_sleep_seconds", defaultValue = "5")
     ...
     */
    @DisconfConfigAnnotation(springBootName = "user-define-download-dir", disconName = "disconf.user_define_download_dir", defaultValue = "./disconf/downloa")
    private String userDefineDownloadDir = "./disconf/download";

    /**
     * 下载的文件会被迁移到classpath根路径下，强烈建议将此选项置为 true(默认是true)
     */
    @DisconfConfigAnnotation(springBootName = "enable-local-download-dirin-class-path", disconName = "disconf.enable_local_download_dir_in_class_path", defaultValue = "true")
